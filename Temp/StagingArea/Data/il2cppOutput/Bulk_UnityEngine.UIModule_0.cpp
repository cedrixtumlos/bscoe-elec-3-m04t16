...
extern "C"  void CanvasRenderer_SetAlpha_m317732912 (CanvasRenderer_t2598313366 * __this, float ___alpha0, const RuntimeMethod* method)
{
	typedef void (*CanvasRenderer_SetAlpha_m317732912_ftn) (CanvasRenderer_t2598313366 *, float);
	static CanvasRenderer_SetAlpha_m317732912_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (CanvasRenderer_SetAlpha_m317732912_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.CanvasRenderer::SetAlpha(System.Single)");
	_il2cpp_icall_func(__this, ___alpha0);
}
